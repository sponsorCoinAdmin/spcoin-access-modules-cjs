...
constructor(_spCoinContractDeployed, _signer) {
    ...
    this.spCoinSigner = _spCoinContractDeployed.connect(_signer)
  }
  ...
  spCoinLogger.logDetail("JS => Inserting " + _recipientKey + " Recipient To Blockchain Network");
    ...
    this.spCoinSigner.addRecipient(_recipientKey);
  ...
  addAgent = async (_recipientKey, _recipientRateKey, _accountAgentKey) => {
    ...
    this.spCoinSigner.addAgent(_recipientKey, _recipientRateKey, _accountAgentKey);
  ...
  addAccountRecord = async (_accountKey) => {
    ...
    this.spCoinSigner.addAccountRecord(_accountKey);
    spCoinLogger.logExitFunction();
  };
  ...
  addAccountRecords = async (_accountListKeys) => {
    ...
    for (idx = 0; idx < maxCount; idx++) {
      ...
      this.spCoinSigner.addAccountRecord(account);
    }
