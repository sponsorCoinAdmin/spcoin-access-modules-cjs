...
constructor(_spCoinContractDeployed, _spCoinContractSigned) {
    ...
    this.spCoinContractSigned = _spCoinContractSigned;
  }
  ...
  spCoinLogger.logDetail("JS => Inserting " + _recipientKey + " Recipient To Blockchain Network");
    ...
    this.spCoinContractSigned.addRecipient(_recipientKey);
  ...
  addAgent = async (_recipientKey, _recipientRateKey, _accountAgentKey) => {
    ...
    this.spCoinContractSigned.addAgent(_recipientKey, _recipientRateKey, _accountAgentKey);
  ...
  addAccountRecord = async (_accountKey) => {
    ...
    this.spCoinContractSigned.addAccountRecord(_accountKey);
    spCoinLogger.logExitFunction();
  };
  ...
  addAccountRecords = async (_accountListKeys) => {
    ...
    for (idx = 0; idx < maxCount; idx++) {
      ...
      this.spCoinContractSigned.addAccountRecord(account);
    }
