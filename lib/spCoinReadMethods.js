...
class SpCoinReadMethods {
  ...
  getAccountList = async () => {
    ...
    let insertedAccountList = _spCoinContractSigned.getAccountList();
  ...
  getAccountRecipientList = async (_accountKey) => {
    ...
    let recipientAccountList = _spCoinContractSigned.getAccountRecipientList(_accountKey);
    spCoinLogger.logExitFunction();
  ...
  getRewardTypeRecord = async (_accountKey, _rewardType, _reward) => {
    ...
    rewardsStr = _spCoinContractSigned.getRewardAccounts(_accountKey, _rewardType);
  ...
  getAccountRecords = async() => {
    ...
    spCoinLogger.logFunctionHeader("getAccountRecords()");
    let accountArr = [];
    // let accountList = _spCoinContractSigned.getAccountList();
  ...
  getAgentRateList = async (_sponsorKey, _recipientKey, _recipientRateKey, _agentKey) => {
    ...
    let networkRateKeys = _spCoinContractSigned.getAgentRateList(_sponsorKey, _recipientKey, _recipientRateKey, _agentKey);
    let agentRateList = [];
  ...
  getAgentRecord = async(_sponsorKey, _recipientKey, _recipientRateKey, _agentKey) => {
    ...
    agentRecord.stakedSPCoins = bigIntToDecString(_spCoinContractSigned.getAgentTotalRecipient(_sponsorKey, _recipientKey, _recipientRateKey, _agentKey));
  ...
  getAgentRateTransactionList = async(_sponsorCoin, _recipientKey, _recipientRateKey, _agentKey, _agentRateKey) => {
    ...
    let agentRateTransactionList = _spCoinContractSigned.getSerializedRateTransactionList(_sponsorCoin, _recipientKey, _recipientRateKey, _agentKey, _agentRateKey);
    spCoinLogger.logExitFunction();
  ...
  getRecipientRateAgentList = async (_sponsorKey, _recipientKey, _recipientRateKey) => {
    ...
    let agentAccountList = _spCoinContractSigned.getRecipientRateAgentList(_sponsorKey, _recipientKey, _recipientRateKey);
    spCoinLogger.logExitFunction();
  ...
  getRecipientRateList = async(_sponsorKey, _recipientKey) => {
    ...
    let networkRateKeys = _spCoinContractSigned.getRecipientRateList(_sponsorKey, _recipientKey);
  ...
  getRecipientRateTransactionList = async(_sponsorCoin, _recipientKey, _recipientRateKey) => {
    ...
    let agentRateTransactionList = _spCoinContractSigned.getRecipientRateTransactionList(_sponsorCoin, _recipientKey, _recipientRateKey);
    spCoinLogger.logExitFunction();
    return spCoinSerialize.deserializeRateTransactionRecords(agentRateTransactionList);
  }
}
